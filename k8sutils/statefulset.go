...
func GenerateStateFulSetsDef(cr *redisv1.Redis, labels map[string]string, role string, replicas *int32) *appsv1.StatefulSet {
...
func GenerateContainerDef(cr *redisv1.Redis, role string) corev1.Container {
...
func FinalContainerDef(cr *redisv1.Redis, role string) []corev1.Container {
...
func CreateRedisMaster(cr *redisv1.Redis) {
...
func CreateRedisSlave(cr *redisv1.Redis) {
	labels := map[string]string{
...
func CreateRedisStandalone(cr *redisv1.Redis) {
...
func CompareAndCreateStateful(cr *redisv1.Redis, clusterInfo StatefulInterface, err error) {
...
func CreatePVCTemplate(cr *redisv1.Redis, role string) corev1.PersistentVolumeClaim {
	reqLogger := log.WithValues("Request.Namespace", cr.Namespace, "Request.Name", cr.ObjectMeta.Name)
